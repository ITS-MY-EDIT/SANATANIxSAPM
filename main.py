...
def load_plugins(plugin_name):
    path = Path(f"SANATANIxSPAM/modules/{plugin_name}.py")
    spec = importlib.util.spec_from_file_location(f"SANATANIxSPAM.modules.{plugin_name}", path)
...
print("\🇸ᴀ ɴ ᴀ ᴛ ᴀ ɴ ɪ ₰ 𝗦𝗣𝗔𝗠 𝗕𝗢𝗧 𝗗𝗘𝗣𝗟𝗢𝗬𝗘𝗗 𝗦𝗨𝗖𝗖𝗘𝗦𝗦𝗙𝗨𝗟𝗟𝗬⚡\nMy Master ---> 🦋⃟ ᴠͥɪͣᴘͫ 🇸ᴀ ɴ ᴀ ᴛ ᴀ ɴ ɪ  ⃝⃝⃪⃕🥀🦋͜͡•─⃛͢ @V_VIP_OWNER")
